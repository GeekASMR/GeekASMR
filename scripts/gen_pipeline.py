...
NODES_LIGHT = [
    ("win",   "🪟 Windows",    "系统音频",   60,  100, "#555555"),
    ("wdm",   "⚙️ WDM",         "内核驱动",   320, 100, "#E91E63"),
    ("vst",   "🔌 VST3",        "桥接插件",   580, 100, "#E91E63"),
    ("daw",   "🎚 DAW",         "数字音频工作站", 840, 100, "#00599C"),
    ("net",   "🌐 Network Ultra", "跨网协作中继", 580, 230, "#9C27B0"),
    ("remote","👥 远端 DAW",    "全世界",     840, 230, "#555555"),
]

NODES_DARK = [
    ("win",   "🪟 Windows",    "系统音频",   60,  100, "#bbbbbb"),
    ("wdm",   "⚙️ WDM",         "内核驱动",   320, 100, "#FF4080"),
    ("vst",   "🔌 VST3",        "桥接插件",   580, 100, "#FF4080"),
    ("daw",   "🎚 DAW",         "数字音频工作站", 840, 100, "#7AB8FF"),
    ("net",   "🌐 Network Ultra", "跨网协作中继", 580, 230, "#C26FFF"),
    ("remote","👥 远端 DAW",    "全世界",     840, 230, "#bbbbbb"),
]
