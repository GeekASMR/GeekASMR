...
# 布局: 4 节点等距铺满 1280 宽度,每个 NODE_W=220,gap = (1280-4*220)/5 = 80
NODES_LIGHT = [
    ("win",   "🪟 Windows",    "系统音频",    80,  100, "#555555"),
    ("wdm",   "⚙️ WDM",         "内核驱动",    380, 100, "#E91E63"),
    ("vst",   "🔌 VST3",        "桥接插件",    680, 100, "#E91E63"),
    ("daw",   "🎚 DAW",         "数字音频工作站", 980, 100, "#00599C"),
    ("net",   "🌐 Network Ultra", "跨网协作中继",  680, 230, "#9C27B0"),
    ("remote","👥 远端 DAW",    "全世界",      980, 230, "#555555"),
]

NODES_DARK = [
    ("win",   "🪟 Windows",    "系统音频",    80,  100, "#bbbbbb"),
    ("wdm",   "⚙️ WDM",         "内核驱动",    380, 100, "#FF4080"),
    ("vst",   "🔌 VST3",        "桥接插件",    680, 100, "#FF4080"),
    ("daw",   "🎚 DAW",         "数字音频工作站", 980, 100, "#7AB8FF"),
    ("net",   "🌐 Network Ultra", "跨网协作中继",  680, 230, "#C26FFF"),
    ("remote","👥 远端 DAW",    "全世界",      980, 230, "#bbbbbb"),
]
